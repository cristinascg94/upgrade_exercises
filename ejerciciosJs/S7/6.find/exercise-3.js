...
const alienCucushumushu = aliens.find(function(alien){
    return alien.name = 'Cucushumushu';
});

const mutationPorompomper = mutations.find(function(mutation){
    return mutation.name === 'Porompomper';
});

alienCucushumushu.mutation = mutationPorompomper;